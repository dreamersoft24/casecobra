    ...
    <div className="relative flex flex-1 flex-col items-center justify-center w-full ">
               ...
               'image/jpg':['.jpg'],
                ...
                >
                    ...
                    {...getRootProps()}>
                        <input {...getInputProps()} />
                        {isDragOver? <MousePointerSquareDashed className="h-6 w-6 text-zinc-500 mb-2"/> :isUploading || isPending ? <Loader2 className="animate-spin h-6 w-6 text-zinc-600 mb-2" />:<Image className="h-6 w-6 text-zinc-600 mb-2"/>}
