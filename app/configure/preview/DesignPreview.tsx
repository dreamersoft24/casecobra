...
const DesignPreview=({configuration}:{configuration:configuration})=>{
    ...
    select-none absolute inset-0 overflow-hidden flex justify-center ">
  ...
  colors: ["#a864fd", "#29cdff", "#78ff44", "#ff718d", "#fdff6a"]}}/>
    ...
    <div className="mt-20 flex flex-col items-center md:grid   text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
        ...
        <div className="mt-6 sm:col-span-9  md:row-end-1">
            ...
            <div className="mt-3 flex items-center gap-1.5  text-base">
                <Check className="h-4 after:w-4 text-green-500"/>
            ...
            <div className="grid grid-cols-1 gap-y-8  border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
                <div>
                    ...
                    <ol className="mt-3 text-zinc-700 list-disc list-inside ">
                        ...
                        <li>Pakaging made from recycled material</li>
                ...
                <div>
                    ...
                    <ol className="mt-3 text-zinc-700 list-disc list-inside">
                      <li>High quality, durabale material</li>  
                      <li>Scratcth- and fingerprint resistant   coating  </li>  
                    </ol>
                </div>
            </div>
    ...
    <div className="mt-8 flex justify-end pb-12 ">
        <Button  isLoading={isPending} disabled={isPending} loadingText="Redirecting"  onClick={()=>handleCheckout()} className="px-4 sm:px-6 lg:px-8">Check out <ArrowRight className="h-4 w-4 ml-1.5  inline"/></Button>
        </div>            
            </div>
        </div>
    </div>
