        ...
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            ...
            <div className="mt-10 border-t border-zinc-200">
                <div className="mt-10 flex flex-auto flex-col ">
                    ...
                    <p className="mt-2 text-sm text-zinc-600">We at CaseCobra believe that a phone case does'nt only need to look good, but also last you for the years to come.We offer a 5-year print guarantee: If your isn't of the heighest quality, we'll replace it for free.</p>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="grid grid-col-2 gap-x-6 border-t border-zinc-200 py-10  text-sm ">
                    <div>
