...
const OrderReceivedEmail=({
  ...
  orderDate:string
    ...
    const baseUrl=process.env.NODE_ENV=='development' ?'http://localhost:3000':'https://casecobra-ten-xi.vercel.app'
return <Html>
    ...
    <Body style={main}>
        <Container style={container}>
            ...
            <Text style={global.text}>We're preparing everything for delivery and will notify you once your package has been shipped. Delivery usually takes  2 days.</Text>
            ...
            <Section style={paddingY}>
              <Row>
                <Text style={{...footer.text,paddingTop:30,paddingBottom:30}}>
                  Please contact us if you have any questions. (if you reply this email we wo'nt be able to see it.)
                </Text>
              </Row>
              <Row>
